...
@Component({
  ...
  styleUrls: ['./renter-management.component.scss']
})
export class RenterManagementComponent implements OnInit {
  renterListData: any[] = [];
  title = "Renter List";
  page: number = 1;
  orderHeader: String = "";
  ...
  editListDetail(data: any, index: any) {
    ...
    this.router.navigate(["/renter-management"], { queryParams: { id: index } });
  }
